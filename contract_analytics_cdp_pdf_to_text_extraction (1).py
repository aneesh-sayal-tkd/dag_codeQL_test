...
cluster_config = {
  ...
  "cluster_log_conf": {
    "s3": {
      "destination": "s3://tpc-aws-ted-tst-edpp-airflow-cc-analytics-usbu-us-east-1/cluster_logs",
      "region": "us-east-1"
    }
  },
  ...
  "aws_attributes": {
    ...
    "first_on_demand": 2,
    "instance_profile_arn": "arn:aws:iam::671616840389:role/TEC-EC2-DATABRICKS-USTST-DE-USBU-CONTRACT-CLASSIFICATION-ROLE"
  },
...
task_CONTRACT_CDP_NOTEBOOK_DATA_SPECIFICATION_EXTRACTION = DatabricksSubmitRunOperator(
                            ...
                            notebook_task = {
                                "notebook_path" : "/Workspace/Repos/CORP-CDP/CDP-Framework-V2/CDP_AUTOMATION/CDP_Framework/Wrapper",
                                "base_parameters" : {"job_id": "CONTRACT-CDP-NOTEBOOK-DATA-SPECIFICATION-EXTRACTION", "job_name": "CONTRACT-CDP-NOTEBOOK-DATA-SPECIFICATION-EXTRACTION", "batch_name": "contract_analytics_cdp_pdf_to_text_extraction", "user_id": "varun.potlacheruvu@takeda.com", "app_id": "contract_analytics_cdp_test_airflow", "entity_id": "CONTRACT-CDP-NOTEBOOK-DATA-SPECIFICATION-EXTRACTION", "sns_topic_arn": SNS_TOPIC_ARN, "mwaa_region": MWAA_REGION, "mwaa_env_name": MWAA_ENV_NAME, "mwaa_iam_role": MWAA_IAM_ROLE, "custom_notebook_path": "/Workspace/Repos/CONTRACT-CLASSIFICATION-REPOSITORY/contract-classification-codebase/CC_code_CN/data_specification_attribute_extraction_CN", "custom_notebook_param": ""},
                                "source" : "WorkSpace"
                            },
                            existing_cluster_id = "{{ task_instance.xcom_pull(task_ids='start_cluster') }}", 
...
task_CONTRACT_CDP_NOTEBOOK_CUSTOMER_DETAILS_EXTRACTION = DatabricksSubmitRunOperator(
                            ...
                            notebook_task = {
                                "notebook_path" : "/Workspace/Repos/CORP-CDP/CDP-Framework-V2/CDP_AUTOMATION/CDP_Framework/Wrapper",
                                "base_parameters" : {"job_id": "CONTRACT-CDP-NOTEBOOK-CUSTOMER-DETAILS-EXTRACTION", "job_name": "CONTRACT-CDP-NOTEBOOK-CUSTOMER-DETAILS-EXTRACTION", "batch_name": "contract_analytics_cdp_pdf_to_text_extraction", "user_id": "varun.potlacheruvu@takeda.com", "app_id": "contract_analytics_cdp_test_airflow", "entity_id": "CONTRACT-CDP-NOTEBOOK-CUSTOMER-DETAILS-EXTRACTION", "sns_topic_arn": SNS_TOPIC_ARN, "mwaa_region": MWAA_REGION, "mwaa_env_name": MWAA_ENV_NAME, "mwaa_iam_role": MWAA_IAM_ROLE, "custom_notebook_path": "/Workspace/Repos/CONTRACT-CLASSIFICATION-REPOSITORY/contract-classification-codebase/CC_code_CN/customer_attribute_extraction_CN", "custom_notebook_param": ""},
                                "source" : "WorkSpace"
                            },
                            existing_cluster_id = "{{ task_instance.xcom_pull(task_ids='start_cluster') }}", 
...
start_cluster_task >> batch_start_control >> task_CONTRACT_CDP_NOTEBOOK_DATA_SPECIFICATION_EXTRACTION >> task_CONTRACT_CDP_NOTEBOOK_DATA_SPECIFICATION_EXTRACTION >> task_CONTRACT_ANALYTICS_CDP_PROCESS_PDF_TO_TEXT_EXTRACTION >> batch_stop_control >> terminate_cluster_task
